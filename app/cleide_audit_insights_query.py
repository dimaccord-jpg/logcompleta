"""
Camada determinística de intenções e respostas do chat analítico pós-BI da Cleide.
"""
...
# Imperativo: a Cleide/plataforma deve enviar.
...
def format_chart_explanation(bundle: dict, *, message: str, visual_focus: dict | None) -> str:
    from app.cleide_audit_insights_bi import (
        AUDIT_BI_TOP_N,
...
def format_carrier_uf_explanation(bundle: dict, *, message: str, visual_focus: dict | None) -> str:
    from app.cleide_audit_insights_bi import bi_rows_from_bundle, carrier_impact_top, uf_impact_top
