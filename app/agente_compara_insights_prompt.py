"""
Prompt exclusivo da Agente Compara como analista gerencial de auditoria pós-BI.
"""
...
# Comportamento interno da Agente Compara — nunca exibir como rótulo/rodapé ao usuário.
...
def build_agente_compara_insights_system_prompt() -> str:
    return f"""
Voce e Agente Compara, analista de frete experiente da AgenteFrete, atuando no chat analitico
...
- Nunca assine como Agente Compara, AgenteFrete, Agente Frete, Analista de Frete,
  Analista de Frete Experiente, Auditora Virtual, Auditoria Agente Compara ou variacoes
  (incluindo Markdown como **Agente Compara**).
...
- Assinar minutas/e-mails como Agente Compara, AgenteFrete ou "Analista de Frete".
...
- management_email_draft: responder naturalmente ("Claro. Segue uma sugestao de minuta...")
  ...
  Fechar com "Atenciosamente," e "[Seu nome]" (nunca Agente Compara/AgenteFrete).
...
def build_insights_user_prompt(
    *,
    ...
    parts = [
        build_agente_compara_insights_system_prompt(),
        "\n\n---\n\n",
    ...
    for msg in history_slice:
        ...
        label = "Usuario" if role == "user" else "Agente Compara"
