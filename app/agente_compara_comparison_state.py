...
def public_comparison_calculation_summary(
    ...
    *,
    ...
    payload = {
        ...
        "memory_size_bytes": calc.get("memory_size_bytes"),
        "raw_result_size_bytes": calc.get("raw_result_size_bytes"),
        "compact_result_size_bytes": calc.get("compact_result_size_bytes"),
        "memory_payload_size_bytes": calc.get("memory_payload_size_bytes"),
        "result_envelope_size_bytes": calc.get("result_envelope_size_bytes"),
        "memory_envelope_size_bytes": calc.get("memory_envelope_size_bytes"),
        "compaction_ratio": calc.get("compaction_ratio"),
        "serialization_duration_ms": calc.get("serialization_duration_ms"),
        "memory_save_duration_ms": calc.get("memory_save_duration_ms"),
        "result_save_duration_ms": calc.get("result_save_duration_ms"),
        "failed_artifact": calc.get("failed_artifact"),
        "failed_stage": calc.get("failed_stage"),
        "last_completed_stage": calc.get("last_completed_stage"),
        "retryable": bool(calc.get("retryable")),
        "safe_message": calc.get("safe_message"),
